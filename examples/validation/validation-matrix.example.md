...
| Change type | Example checks |
| --- | --- |
| Docs-only | Markdown review, link review, whitespace/diff check |
| Product UI package | Typecheck, component tests, public API review, product boundary guard |
